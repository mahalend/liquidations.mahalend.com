...
export interface IconLoaderProps {
  iconName:
    ...
    'Sync' | 'InfoToolTip' | 'Cross' | 'Calendar' | 'Menu' | 'Transaction' | 'Wallet' | 'Copy' | 'Copied' | 'Search' | 'DotMenu' |
    'Loans' | 'Starter' |
    'Add' | 'Delete' | 'DeleteFaded' | 'Settings' | 'Default' | 'Tick' | 'ProposalPending' | 'BentoMenu' | string;
  iconType?: 'arrow' | 'infoTip' | 'exchangePlatform' | 'socialMedia' | 'products' | 'status' | 'tokenSymbol' | 'misc' | 'brandLogo' | 'checkbox' | 'chains';
  height?: number | 'auto';
  width?: number | 'auto';
  className?: string;
  onClick?: () => void;
